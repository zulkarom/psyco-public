...
window.addEventListener('load', function () {
  ...
  if (document.getElementById('ms_imp_list1')) {
    var ex2ImportantListbox1 = new aria.Listbox(
      document.getElementById('ms_imp_list1')
    );
    var ex2UnimportantListbox1 = new aria.Listbox(
      document.getElementById('ms_unimp_list1')
    );

    ex2ImportantListbox1.setupMove(
      document.getElementById('ex2-add1'),
      ex2UnimportantListbox1
    );
    ex2UnimportantListbox1.setupMove(
      document.getElementById('ex2-delete1'),
      ex2ImportantListbox1
    );

  }
  
  if (document.getElementById('ms_imp_list2')) {
    var ex2ImportantListbox2 = new aria.Listbox(
      document.getElementById('ms_imp_list2')
    );
    var ex2UnimportantListbox2 = new aria.Listbox(
      document.getElementById('ms_unimp_list2')
    );

    ex2ImportantListbox2.setupMove(
      document.getElementById('ex2-add2'),
      ex2UnimportantListbox2
    );
    ex2UnimportantListbox2.setupMove(
      document.getElementById('ex2-delete2'),
      ex2ImportantListbox2
    );

  }
  
  if (document.getElementById('ms_imp_list3')) {
    var ex2ImportantListbox3 = new aria.Listbox(
      document.getElementById('ms_imp_list3')
    );
    var ex2UnimportantListbox3 = new aria.Listbox(
      document.getElementById('ms_unimp_list3')
    );

    ex2ImportantListbox3.setupMove(
      document.getElementById('ex2-add3'),
      ex2UnimportantListbox3
    );
    ex2UnimportantListbox3.setupMove(
      document.getElementById('ex2-delete3'),
      ex2ImportantListbox3
    );

  }
  
  if (document.getElementById('ms_imp_list4')) {
    var ex2ImportantListbox4 = new aria.Listbox(
      document.getElementById('ms_imp_list4')
    );
    var ex2UnimportantListbox4 = new aria.Listbox(
      document.getElementById('ms_unimp_list4')
    );

    ex2ImportantListbox4.setupMove(
      document.getElementById('ex2-add4'),
      ex2UnimportantListbox4
    );
    ex2UnimportantListbox4.setupMove(
      document.getElementById('ex2-delete4'),
      ex2ImportantListbox4
    );
